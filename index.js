...
const fundraisingInfo = `
  ...
  ${numUnfundedGames === 0 ? 'All' : numUnfundedGames} ${numUnfundedGames === 1 ? 'game is' : 'games are'} unfunded.
`;
// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement("p");
descriptionElement.innerHTML = fundraisingInfo;
...
firstGameElement.innerHTML = `Top Pledge Game: ${firstGame.name} - $${firstGame.pledged.toLocaleString()}`;
firstGameContainer.appendChild(firstGameElement);

// do the same for the runner up item
const secondGameElement = document.createElement("p");
secondGameElement.innerHTML = `Runner-up Game: ${secondGame.name} - $${secondGame.pledged.toLocaleString()}`;
